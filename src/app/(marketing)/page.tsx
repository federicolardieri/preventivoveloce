        ...
        <div className="max-w-4xl mx-auto relative z-10 w-full">
          ...
          <div className="bg-[#111118] border border-white/6 rounded-3xl p-6 sm:p-10 shadow-2xl">
            {[
              ...
              { q: 'I miei dati monetari e quelli dei clienti sono al sicuro?', a: 'La massima riservatezza è garantita al 100%. Lavoriamo su infrastrutture cloud crittografate di livello enterprise. Le stesse firme digitali e log di accettazione sono marcati temporalmente, salvati su cluster sicuri e allegati per darti massima solidità e prova d\'intenti inalterabile con il cliente.' },
