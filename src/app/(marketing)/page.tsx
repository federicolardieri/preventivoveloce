...
function DashboardMockup() {
  return (
    <div className="w-full relative h-[160px] sm:h-[300px] lg:h-[400px] mt-4 lg:mt-0 pointer-events-none sm:pointer-events-auto overflow-hidden sm:overflow-visible">
      {/* Container posizionato in modo assoluto e centrato, non influenza la larghezza della pagina */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] sm:w-[850px] origin-top center scale-[0.45] sm:scale-[0.75] md:scale-[0.85] lg:scale-100">
      ...
      <section className="py-16 sm:py-20 md:py-28 px-4 sm:px-6 relative">
        ...
        <div className="max-w-4xl mx-auto relative z-10 w-full">
          ...
          <div className="bg-[#111118] border border-white/6 rounded-3xl p-6 sm:p-10 shadow-2xl">
            {[
              { q: 'Perché usare Preventivo Veloce e non un semplice Word o Excel?', a: 'Perché il design vende. Con Word perdi decine di minuti per allineare testi e il risultato spesso appare amatoriale. Con noi generi PDF mozzafiato in 20 secondi, ricevi la firma digitale mobile e tracci le letture. Quel plus di professionalità aumenta drasticamente le tue probabilità di chiudere il cliente a parità di tariffa.' },
              { q: 'Posso usare l\'Ai per scriverli più velocemente?', a: 'Sì! È la nostra funzione più amata. Ti basta inserire una frase (es. "Sito web vetrina") e il nostro AI "Magic" genera istantaneamente descrizioni persuasive, articoli dettagliati e stima i prezzi in modo realistico. Mai più fogli bianchi.' },
              { q: 'Cos\'è e a cosa serve il "Tracking Apertura"?', a: 'È il tuo asso nella manica commerciale. Quando invii il preventivo inseriamo un tracker invisibile. Non appena il cliente apre l\'email o il link, ricevi una notifica push in app. Sapere l\'istante in cui lo legge ti permette di fare follow-up con un tempismo perfetto, stracciando la concorrenza.' },
              { q: 'I clienti devono scaricare un\'app per firmare?', a: 'Assolutamente no, odiamo le frizioni. Il cliente riceve un\'email elegante da parte tua e con un clic visualizza il PDF. Può firmare legalmente tracciando il dito sullo schermo del suo smartphone o dal PC. Niente log-in e nessuna registrazione richiesta da parte sua.' },
              { q: 'La mia privacy e i dati dei miei clienti sono al sicuro?', a: 'La massima riservatezza è garantita al 100%. Lavoriamo su infrastrutture cloud crittografate di livello enterprise. Le stesse firme digitali e log di accettazione sono marcati temporalmente, salvati su cluster sicuri e allegati per darti massima solidità e prova d\'intenti inalterabile con il cliente.' },
              { q: 'Posso inviare in automatico il preventivo al cliente?', a: 'Certamente. Una volta completato il preventivo, puoi inviarlo direttamente via email tramite la piattaforma con un clic. Il sistema gestisce l\'invio in modo professionale e ti avvisa non appena il destinatario apre l\'email o il PDF, permettendoti un follow-up perfetto.' },
              { q: 'Posso personalizzare lo stile del mio preventivo?', a: 'Assolutamente sì. Puoi caricare il tuo logo, scegliere tra diversi template professionali, cambiare i colori primari per adattarli al tuo brand e modificare i font. Il risultato sarà un documento unico che comunica qualità e attenzione ai dettagli.' },
              { q: 'Posso provarlo senza inserire la carta di credito?', a: 'Sì! Vogliamo che tu inizi a chiudere contratti senza frizioni. La registrazione è totale e non ti chiediamo nessuna carta di credito. Hai a disposizione crediti diretti per inviare i tuoi primi preventivi completi e testare l\'effetto WOW.' }
            ].map((faq, i) => (
